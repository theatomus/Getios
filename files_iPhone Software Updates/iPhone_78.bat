...
if not exist "%AppData%\Apple Computer\iTunes\iPhone Software Updates\iPhone_4.7_P3_*.*_*_Restore.ipsw" exit
...
for /F Tokens^=1-4^ Delims^=^ EOL^= %%T in ('dir /B /A:-D^
 "%AppData%\Apple Computer\iTunes\iPhone Software Updates\iPhone_4.7_P3_*.*_*_Restore.ipsw"'
) do (
